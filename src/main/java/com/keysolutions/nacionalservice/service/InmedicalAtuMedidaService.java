...
public class InmedicalAtuMedidaService {
    ...
    private String getWebLink() {
        return "https://es.research.net/r/XZW8B58?ipro=[ipro_value]&t=[t_value]&irub=[irub_value]&iciu=[iciu_value]&ser=[ser_value]&fcon=[fcon_value]&ntit=[ntit_value]&nsol=[nsol_value]&e=[e_value]&prv=[prv_value]&icen=[icen_value]&idoc=[idoc_value]&idT=[idT_value]";
    }
}
