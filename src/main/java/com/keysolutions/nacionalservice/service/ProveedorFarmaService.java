    ...
    private void sendJira(List<ProveedorFarma> proveedorFarmaList) {
        for (ProveedorFarma proveedorFarma : proveedorFarmaList) {
            try {
                ...
                manageLog.recorJiralog(Utils.createJiraLog(issue.getIssueId(),issue.getIssueKey(),issue.getRequestTypeId(),issue.getServiceDeskId(),Constant.CONFIG_PROVEEDOR_FARMA,fileName));
