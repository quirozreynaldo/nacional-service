    ...
    public void createJiraSurvey() {
        ...
        for (AsistenciaVial asistenciaVial : asistenciaVialList) {
            try {
                ...
                manageLog.recorJiralog(Utils.createJiraLog(issue.getIssueId(),issue.getIssueKey(),issue.getRequestTypeId(),issue.getServiceDeskId(),Constant.CONFIG_ASISTENCIA_VIAL,fileName));
